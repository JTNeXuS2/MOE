...
6. run "!START-minimal_TEST_CLUSTER.cmd" for start core and one server or "!START_CLUSTER.cmd" for full start claster
	...
	if everything works fine run "Auto_Update_Backup_Claster.bat" to automatically run the cluster servsers ![Screen](https://junger.zzux.com/webhook/MOE_DLC/Screenshot_5.png)
