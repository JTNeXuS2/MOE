...
echo =======================================================================
TIMEOUT /t 3
set rcon_host=65.109.113.61
set "rcon_pass=RCONSUPERPASSWORD"

echo Lobby
set port=6003
%mcrcon_dir%\mcrcon.exe -H %rcon_host% -P %port% -p %pass% "SetServerMultiplier ?SessionName=[RU/EU]Mirnaya Pycb [PvEvP/BG/GvG/Kits/Shop]"
